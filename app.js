    ...
    const THEMES = [
        {
            ...
            textColor: '#1c2833',
            photoBox: { top: '60.8%', left: '5.8%', width: '33.5%', height: '30.5%' },
            fields: [
                { id: 'poke_id_front', label: 'ID No.', top: '5.5%', left: '58.0%', width: '27%', defaultText: '007849', fontSize: '0.85rem' },
                { id: 'poke_name_front', label: 'Name', top: '14.5%', left: '16.4%', width: '36%', defaultText: 'enter name', fontSize: '0.8rem' },
                { id: 'poke_money_front', label: 'Money', top: '20.8%', left: '21.5%', width: '28%', defaultText: '999', fontSize: '0.75rem' },
                { id: 'poke_dex_front', label: 'Pokédex', top: '26.5%', left: '21.5%', width: '28%', defaultText: '151 / 151', fontSize: '0.75rem' },
                { id: 'poke_time_front', label: 'Play Time', top: '32.2%', left: '24%', width: '28%', defaultText: '250:45', fontSize: '0.75rem' },
                { id: 'poke_name_back', label: 'Name', top: '59.5%', left: '55.0%', width: '38%', defaultText: 'enter name', fontSize: '0.8rem' },
                { id: 'poke_id_back', label: 'ID No.', top: '63.4%', left: '55.2%', width: '38%', defaultText: '007849', fontSize: '0.8rem' },
                { id: 'poke_money_back', label: 'Money', top: '67.0%', left: '55.3%', width: '38%', defaultText: '$999,999', fontSize: '0.75rem' },
                { id: 'poke_dex_back', label: 'Pokédex', top: '70.2%', left: '57.9%', width: '38%', defaultText: '151 / 151', fontSize: '0.75rem' },
                { id: 'poke_time_back', label: 'Play Time', top: '74.0%', left: '60.5%', width: '38%', defaultText: '250:45', fontSize: '0.75rem' },
        ...
        },
        {
            ...
            textColor: '#0f172a',
            photoBox: { top: '14.0%', left: '65.9%', width: '26.5%', height: '26.5%' },
            fields: [
                { id: 'hero_name', label: 'Name', top: '13.5%', left: '11.5%', width: '51%', defaultText: 'enter name', fontSize: '0.85rem' },
                { id: 'hero_agency', label: 'Agency', top: '17.5%', left: '13.5%', width: '50%', defaultText: 'Might Agency', fontSize: '0.85rem' },
                { id: 'hero_grade', label: 'Grade', top: '21.5%', left: '13.5%', width: '51%', defaultText: 'Class 1-A Hero', fontSize: '0.85rem' },
                { id: 'hero_issued', label: 'Issued', top: '25.0%', left: '13.5%', width: '51%', defaultText: '2026-08-20', fontSize: '0.85rem' },
                { id: 'hero_quirk', label: 'Quirk', top: '28.5%', left: '13.5%', width: '52%', defaultText: 'One For All', fontSize: '0.85rem' },
                { id: 'hero_code_name', label: 'Hero Name', top: '35.8%', left: '4.0%', width: '60%', defaultText: 'hero name', fontSize: '2.6rem' },
                { id: 'hero_id_num', label: 'ID#', top: '2.8%', left: '73.0%', width: '11%', defaultText: '98402', fontSize: '0.7rem', font: "'Courier Prime', monospace" },
                { id: 'hero_reff_num', label: 'Reff#', top: '5.2%', left: '73.0%', width: '11%', defaultText: '7721', fontSize: '0.7rem', font: "'Courier Prime', monospace" },
                { id: 'hero_dob', label: 'DOB', top: '42.6%', left: '66.0%', width: '10%', defaultText: '07/15', fontSize: '0.6rem' },
                { id: 'hero_height', label: 'Height', top: '42.6%', left: '81.5%', width: '10%', defaultText: '166cm', fontSize: '0.6rem' },
                { id: 'hero_name_back', label: 'Name', top: '60.6%', left: '46.9%', width: '46%', defaultText: 'enter name', fontSize: '0.85rem' },
                { id: 'hero_id_back', label: 'ID#', top: '65.0%', left: '44.0%', width: '15%', defaultText: '98402', fontSize: '0.85rem', font: "'Courier Prime', monospace" },
                { id: 'hero_reff_back', label: 'Reff#', top: '65.0%', left: '76.5%', width: '17%', defaultText: '7721', fontSize: '0.85rem', font: "'Courier Prime', monospace" },
                { id: 'hero_agency_back', label: 'Agency', top: '68.8%', left: '48.5%', width: '45%', defaultText: 'Might Agency', fontSize: '0.85rem' },
                { id: 'hero_grade_back', label: 'Grade', top: '72.8%', left: '47.8%', width: '46%', defaultText: 'Class 1-A Hero', fontSize: '0.85rem' },
                { id: 'hero_issued_back', label: 'Issued', top: '76.8%', left: '48.0%', width: '46%', defaultText: '2026-08-20', fontSize: '0.85rem' },
                { id: 'hero_quirk_back', label: 'Quirk', top: '80.7%', left: '47.5%', width: '46%', defaultText: 'One For All', fontSize: '0.85rem' }
            ]
        },
        {
            id: 'fight_club',
            ...
            textColor: '#111111',
            photoBox: { top: '8.2%', left: '5.5%', width: '30.5%', height: '30.0%' },
            fields: [
                { id: 'fc_name_cn', label: 'Chinese Name', top: '6.0%', left: '48.0%', width: '42%', defaultText: '搏擊俱樂部', fontSize: '0.99rem' },
                { id: 'fc_name_en', label: 'English Name', top: '12.5%', left: '48.0%', width: '42%', defaultText: 'enter name', fontSize: '1.3rem' },
                { id: 'fc_grade', label: 'Grade', top: '19.8%', left: '49.5%', width: '42%', defaultText: 'FOUNDER / GRADE A', fontSize: '0.99rem' },
                { id: 'fc_service', label: 'Service No', top: '25.5%', left: '54.0%', width: '42%', defaultText: 'FC-632025', fontSize: '0.9rem' },
                { id: 'fc_age', label: 'Age', top: '31.5%', left: '48.0%', width: '42%', defaultText: '30', fontSize: '0.99rem' },
                { id: 'fc_section', label: 'Section', top: '37.5%', left: '50.0%', width: '42%', defaultText: 'SOAP DIVISION', fontSize: '0.9rem' },
                { id: 'fc_date_exp', label: 'Date Expired', top: '43.8%', left: '56.0%', width: '42%', defaultText: '2099-12-31', fontSize: '0.9rem' },
                { id: 'fc_subj_name', label: 'Subject Name', top: '59.5%', left: '6.5%', width: '26%', defaultText: 'THE NARRATOR', fontSize: '0.99rem' },
                { id: 'fc_alias', label: 'Alias', top: '63.9%', left: '8.5%', width: '26%', defaultText: 'JACK', fontSize: '0.99rem' },
                { id: 'fc_blood', label: 'Blood Group', top: '68.5%', left: '7.5%', width: '26%', defaultText: 'O POSITIVE', fontSize: '0.9rem' },
                { id: 'fc_height', label: 'Height', top: '72.0%', left: '9.5%', width: '26%', defaultText: '6 FT 0 IN', fontSize: '0.9rem' },
                { id: 'fc_weight', label: 'Weight', top: '76.0%', left: '9.5%', width: '26%', defaultText: '175 LBS', fontSize: '0.9rem' },
                { id: 'fc_eyes', label: 'Eyes', top: '79.5%', left: '10.5%', width: '26%', defaultText: 'BLUE', fontSize: '0.9rem' },
                { id: 'fc_nationality', label: 'Nationality', top: '83.0%', left: '11.5%', width: '26%', defaultText: 'AMERICAN', fontSize: '0.8rem' },
                { id: 'fc_language', label: 'Language', top: '86.5%', left: '11.5%', width: '26%', defaultText: 'ENGLISH', fontSize: '0.8rem' },
                { id: 'fc_inmate_no', label: 'Inmate No', top: '59.0%', left: '35.5%', width: '26%', defaultText: '94021', fontSize: '0.8rem' },
                { id: 'fc_service_back', label: 'Service No', top: '64.0%', left: '35.5%', width: '26%', defaultText: 'FC-632025', fontSize: '0.8rem' },
                { id: 'fc_date_issue', label: 'Date of Issue', top: '70.0%', left: '35.5%', width: '26%', defaultText: '1999-10-15', fontSize: '0.8rem' },
                { id: 'fc_date_expiry_back', label: 'Date of Expiry', top: '74.0%', left: '35.5%', width: '26%', defaultText: 'NEVER', fontSize: '0.8rem' },
                { id: 'fc_auth_by', label: 'Authorized By', top: '86.5%', left: '35.5%', width: '18%', defaultText: 'T. DURDEN', fontSize: '0.8rem' }
            ]
        },
        {
            id: 'mib',
            ...
            fontFamily: "'Plus Jakarta Sans', sans-serif",
            textColor: '#ffffff',
            photoBox: { top: '34.6%', left: '0.5%', width: '23.3%', height: '33.7%' },
            fields: [
                { id: 'mib_desig', label: 'Agent Designation', top: '31.0%', left: '28.0%', width: '13%', defaultText: 'J', fontSize: '9.0rem', color: '#ffffff' },
                { id: 'mib_race', label: 'Race', top: '71.6%', left: '35%', width: '17%', defaultText: 'HUMAN', fontSize: '0.75rem', font: "'Courier Prime', monospace", color: '#ffffff' },
            ]
        }
    ];
